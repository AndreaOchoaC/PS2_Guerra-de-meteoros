    ...
    # Pista: teclas[pygame.K_LEFT] o teclas[pygame.K_a]
        if evento.type == pygame.KEYDOWN:
            if teclas[pygame.K_LEFT] or teclas[pygame.K_a]:
                jugador_x -= VELOCIDAD_JUGADOR # le restamos una cantidad de píxeles a la posición x del jugador

    # TODO 3: Si se presiona la flecha derecha o "D", aumenta jugador_x
    # Pista: teclas[pygame.K_RIGHT] o teclas[pygame.K_d]
        if evento.type == pygame.KEYDOWN:
            if teclas[pygame.K_RIGHT] or teclas[pygame.K_d]:
                jugador_x += VELOCIDAD_JUGADOR # le sumamos una cantidad de píxeles a la posición x del jugador
